    ...
    <div class="container mt-5 shadow-lg p-3 mb-5 bg-white rounded">
        <form class="row g-3" method="POST" action="{{ route('services.store') }}" enctype="multipart/form-data">
            ...
            <div class="col-12">
              ...
              <input type="text" name="name" value="" class="form-control" id="inputname4" placeholder="Service Name">
            </div>
            <div class="col-md-6">
                <label for="inputprice4" class="form-label">Price</label>
                <input type="number" name="price" value="" class="form-control" id="inputprice4" placeholder="Service Price">
              </div>
              <div class="col-md-6">
                <label for="inputTva" class="form-label">Tva</label>
                <input type="number" name="tva" value="" class="form-control" id="inputTva" placeholder="Taux Tva">
              </div>
